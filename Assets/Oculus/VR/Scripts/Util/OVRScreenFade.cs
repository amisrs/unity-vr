...
public class OVRScreenFade : MonoBehaviour
{
    ...
    public void FadeOutAndIn(float fadeTime)
    {
        StartCoroutine(FadeOutAndIn(0, 1, fadeTime));
    }
	...
	/// </summary>
	public IEnumerator Fade(float startAlpha, float endAlpha, float fadeTime)
	{
    ...
    IEnumerator FadeOutAndIn(float startAlpha, float endAlpha, float fadeTime)
    {
        float elapsedTime = 0.0f;
        while (elapsedTime < fadeTime)
        {
        ...
        while (elapsedTime >= fadeTime && elapsedTime < fadeTime * 2)
        {
            elapsedTime += Time.deltaTime;
