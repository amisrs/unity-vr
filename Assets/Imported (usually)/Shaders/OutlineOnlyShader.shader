...
//https://github.com/Shrimpey/UltimateOutline/blob/master/UltimateOutline.shader
// fixed to work with VR: https://docs.unity3d.com/Manual/SinglePassStereoRenderingHoloLens.html

Shader "Outlined/UltimateOutlineOnly"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline color", Color) = (255,134,0,0.75)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.013

		_SecondOutlineColor("Outline color", Color) = (255,134,0,0.75)
		_SecondOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.013

		_Angle("Switch shader on angle", Range(0.0, 180.0)) = 180.0
	}
